...
export const AR_CONFIG = {
  ...
  visual: {
    ...
    emissiveMax: 0.68,
    emissivePulse: 0.08,
    laserBeamIntensity: 0.2803,
    laserBeamGlowOpacity: 0.0903,
    laserEmitterIntensity: 0.03,
    laserEmitterGlowOpacity: 0.021672,
    laserEmitterApertureIntensity: 0.123332,
    laserEmitterApertureGlowOpacity: 0.057792,
    laserEmitterColor: 0xd9dee6,
    laserBeamColor: 0x7a6cff,
    laserBeamGlowColor: 0x6d7cff,
    bboIntensity: 0.2452,
    bboGlowOpacity: 0.07224,
    bboColor: 0xb8f3ff,
    photonPathIntensity: 0.3153,
    photonPathGlowOpacity: 0.09933,
    photonTrailOpacity: 0.10836,
    ...
    ringOpacity: 0.049665,
    particleOpacity: 0.14,
    textOpacity: 0.68,
    trailOpacity: 0.10836,
    beamOpacity: 0.08127,
    bboPulseOpacity: 0.03612,
    bboAuraOpacity: 0.019866,
    targetFlashOpacity: 0.032508,
    opticalPathColorMix: 0.78,
    opticalPathColorBoost: 1.02,
    laserCoreOpacity: 0.22,
    photonCoreOpacity: 0.24,
    bboCoreOpacity: 0.16,
    portalScale: 0.62,
    textScale: 0.6,
...
const clampRanges = {
  ...
  'visual.opticalPathColorMix': [0, 1],
  'visual.opticalPathColorBoost': [0.7, 1.25],
  'visual.laserCoreOpacity': [0, 1],
  'visual.photonCoreOpacity': [0, 1],
  'visual.bboCoreOpacity': [0, 1],
};
